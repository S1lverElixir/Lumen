...
- **Plain text, no attachments, no freshness need** (the most common case) → straight to OpenRouter. Heavier requests (code, multi-step reasoning, caught by another lightweight heuristic) get routed to the stronger free OpenRouter models first.
