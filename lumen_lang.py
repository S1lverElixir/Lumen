...
STRINGS: dict[str, dict[str, str]] = {
    ...
    "tiktok_dl_slideshow": {
        "be": "Слайдшоў TikTok: {shown}/{total}",
        "en": "TikTok slideshow: {shown}/{total}",
        "es": "Presentación de TikTok: {shown}/{total}",
        "kk": "TikTok слайдшоуы: {shown}/{total}",
        "ru": "Слайдшоу TikTok: {shown}/{total}",
        "uk": "Слайдшоу TikTok: {shown}/{total}",
    },
    "tiktok_guest_dm_hint": {
        "be": "Відэа і слайдшоў спампоўваю толькі ў асабістых паведамленнях — перашлі туды спасылку, і я ўсё зраблю.",
        "en": "I download videos and slideshows only in direct messages — forward the link there and I'll take care of it.",
        "es": "Descargo videos y presentaciones solo en mensajes directos — reenvía el enlace allí y me encargo.",
        "kk": "Видео мен слайдшоуды тек жеке хабарламаларда жүктеймін — сілтемені сонда жібер, қалғанын өзім жасаймын.",
        "ru": "Видео и слайдшоу качаю только в личных сообщениях — перешли туда ссылку, и я всё скачаю.",
        "uk": "Відео та слайдшоу завантажую лише в особистих — перешли туди посилання, і я все зроблю.",
    },
    # ── Статусы ──
...
PACK_PT: dict[str, str] = {
    ...
    "tiktok_dl_slideshow": "Apresentação de slides do TikTok: {shown}/{total}",
    "tiktok_guest_dm_hint": "Baixo vídeos e apresentações só em mensagens diretas — encaminhe o link para lá e eu cuido do resto.",
...
PACK_AR: dict[str, str] = {
    ...
    "tiktok_dl_slideshow": "عرض شرائح TikTok: {shown}/{total}",
    "tiktok_guest_dm_hint": "أحمّل الفيديو وعرض الشرائح في الرسائل الخاصة فقط — أعد توجيه الرابط هناك وسأتكفل بالباقي.",
...
PACK_TR: dict[str, str] = {
    ...
    "tiktok_dl_slideshow": "TikTok slayt gösterisi: {shown}/{total}",
    "tiktok_guest_dm_hint": "Video ve slaytları yalnızca direkt mesajlarda indiriyorum — bağlantıyı oraya ilet, gerisini ben hallederim.",
...
PACK_DE: dict[str, str] = {
    ...
    "tiktok_dl_slideshow": "TikTok-Diashow: {shown}/{total}",
    "tiktok_guest_dm_hint": "Videos und Diashows lade ich nur in Direktnachrichten herunter — leite den Link dorthin weiter, um den Rest kümmere ich mich.",
...
PACK_FR: dict[str, str] = {
    ...
    "tiktok_dl_slideshow": "Diaporama TikTok : {shown}/{total}",
    "tiktok_guest_dm_hint": "Je télécharge vidéos et diaporamas uniquement en messages privés — transfère le lien là-bas, je m'occupe du reste.",
...
PACK_IT: dict[str, str] = {
    ...
    "tiktok_dl_slideshow": "Presentazione TikTok: {shown}/{total}",
    "tiktok_guest_dm_hint": "Scarico video e presentazioni solo nei messaggi diretti — inoltra il link lì e penso io al resto.",
...
PACK_HI: dict[str, str] = {
    ...
    "tiktok_dl_slideshow": "TikTok स्लाइडशो: {shown}/{total}",
    "tiktok_guest_dm_hint": "वीडियो और स्लाइडशो सिर्फ डायरेक्ट मैसेज में डाउनलोड करता हूँ — लिंक वहाँ भेज दो, बाकी मैं संभाल लूँगा।",
...
PACK_ID: dict[str, str] = {
    ...
    "tiktok_dl_slideshow": "Tayangan slide TikTok: {shown}/{total}",
    "tiktok_guest_dm_hint": "Saya mengunduh video dan slideshow hanya di pesan langsung — teruskan tautannya ke sana, sisanya biar saya yang urus.",
...
PACK_MS: dict[str, str] = {
    ...
    "tiktok_dl_slideshow": "Tayangan slaid TikTok: {shown}/{total}",
    "tiktok_guest_dm_hint": "Saya memuat turun video dan tayangan slaid hanya dalam mesej langsung — majukan pautan ke sana, selebihnya saya uruskan.",
...
PACK_VI: dict[str, str] = {
    ...
    "tiktok_dl_slideshow": "Trình chiếu TikTok: {shown}/{total}",
    "tiktok_guest_dm_hint": "Tôi chỉ tải video và trình chiếu trong tin nhắn trực tiếp — chuyển tiếp liên kết vào đó, phần còn lại để tôi lo.",
...
PACK_TH: dict[str, str] = {
    ...
    "tiktok_dl_slideshow": "สไลด์โชว์ TikTok: {shown}/{total}",
    "tiktok_guest_dm_hint": "ฉันดาวน์โหลดวิดีโอและสไลด์โชว์เฉพาะในข้อความส่วนตัว — ส่งลิงก์ไปที่นั่น ที่เหลือฉันจัดการเอง",
...
PACK_FA: dict[str, str] = {
    ...
    "tiktok_dl_slideshow": "اسلایدشوی TikTok: {shown}/{total}",
    "tiktok_guest_dm_hint": "ویدیو و اسلایدشو را فقط در پیام‌های خصوصی دانلود می‌کنم — لینک را آنجا بفرست، بقیه‌اش با من.",
...
PACK_UR: dict[str, str] = {
    ...
    "tiktok_dl_slideshow": "TikTok سلائیڈ شو: {shown}/{total}",
    "tiktok_guest_dm_hint": "ویڈیو اور سلائیڈ شو صرف ڈائریکٹ پیغامات میں ڈاؤن لوڈ کرتا ہوں — لنک وہاں بھیج دو، باقی میں سنبھال لوں گا۔",
...
PACK_UZ: dict[str, str] = {
    ...
    "tiktok_dl_slideshow": "TikTok slayd-shousi: {shown}/{total}",
    "tiktok_guest_dm_hint": "Video va slayd-shoularni faqat shaxsiy xabarlarda yuklayman — havolani o‘sha yerga yubor, qolganini o‘zim qilaman.",
...
PACK_BN: dict[str, str] = {
    ...
    "tiktok_dl_slideshow": "TikTok স্লাইডশো: {shown}/{total}",
    "tiktok_guest_dm_hint": "ভিডিও আর স্লাইডশো শুধু ডাইরেক্ট মেসেজে ডাউনলোড করি — লিংকটা ওখানে পাঠিয়ে দাও, বাকিটা আমি দেখছি।",
...
PACK_FIL: dict[str, str] = {
    ...
    "tiktok_dl_slideshow": "Slideshow ng TikTok: {shown}/{total}",
    "tiktok_guest_dm_hint": "Nagda-download lang ako ng video at slideshow sa direct messages — i-forward ang link doon, ako nang bahala sa iba.",
...
PACK_PL: dict[str, str] = {
    ...
    "tiktok_dl_slideshow": "Pokaz slajdów TikTok: {shown}/{total}",
    "tiktok_guest_dm_hint": "Filmy i pokazy slajdów pobieram tylko w wiadomościach prywatnych — prześlij tam link, resztą się zajmę.",
...
PACK_NL: dict[str, str] = {
    ...
    "tiktok_dl_slideshow": "Diavoorstelling TikTok: {shown}/{total}",
    "tiktok_guest_dm_hint": "Ik download video's en diavoorstellingen alleen in privéberichten — stuur de link daarheen, dan regel ik de rest.",
...
PACK_ZU: dict[str, str] = {
    ...
    "tiktok_dl_slideshow": "Isilayidi se-TikTok: {shown}/{total}",
    "tiktok_guest_dm_hint": "Ngilanda amavidiyo nama-slideshow kuma-DM kuphela — dlulisa isixhumanisi lapho, okunye ngizokunakekela.",
