...
- bot.py (~5000 lines) is the orchestrator. Search it with grep and read ranges instead of loading it whole, unless the task is a full audit. The rest of the code is in lumen_*.py and system_prompt.py; list the directory to find the module you need.
